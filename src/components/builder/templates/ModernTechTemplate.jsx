...
export function ModernTechTemplate({ data, accentColor = '#6366f1', fontFamily = 'sans', spacing = 'balanced' }) {
  if (!data) return null;
  ...
  return (
    <div className={`resume-sheet bg-white text-slate-800 p-8 max-w-[210mm] min-h-[297mm] mx-auto ${fontClass} ${densityStyles[spacing]}`}>
      ...
      {/* Header Banner */}
      <div className="border-b-2 pb-5 flex flex-col md:flex-row justify-between items-start md:items-center gap-4" style={{ borderColor: accentColor }}>
        <div>
