...
export function ProfessionalTemplate({ data, accentColor = '#4f46e5', fontFamily = 'display', spacing = 'balanced' }) {
  if (!data) return null;
...
export const NordicIndigoTemplate = ProfessionalTemplate;
